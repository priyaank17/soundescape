            ...
            <div className="footer2-container">
              <div className="footer2-column1">
                <strong>
                  {props.column1Title ?? (
                    <fragment>
                      <span className="thq-body-large">Explore</span>
                    </fragment>
                  )}
                </strong>
              ...
              <div className="footer2-column2">
                <strong>
                  {props.column2Title ?? (
                    <fragment>
                      <span className="thq-body-large">Resources</span>
                    </fragment>
                  )}
                </strong>
                <div className="footer2-footer-links1">
                  ...
                  >
                    {props.link8 ?? (
                      <fragment>
                        <span className="thq-body-small">Testimonials</span>
                      </fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link10 ?? (
                      <fragment>
                        <span className="thq-body-small">Brainwave States</span>
                      </fragment>
                    )}
                  </a>
                </div>
            ...
            <div className="footer2-actions">
              ...
              <span>
                {props.content2 ?? (
                  <fragment>
                    <span className="thq-body-small">
                      © 2023 Ambient Soundscape. All Rights Reserved.
                    </span>
                  </fragment>
                )}
              </span>
            ...
            <div className="footer2-credits1">
              ...
              <div className="footer2-footer-links2">
                <span>
                  {props.privacyLink ?? (
                    <fragment>
                      <span className="thq-body-small">/privacy</span>
                    </fragment>
                  )}
                </span>
                <span>
                  {props.termsLink ?? (
                    <fragment>
                      <span className="thq-body-small">/terms</span>
                    </fragment>
                  )}
                </span>
                <span>
                  {props.cookiesLink ?? (
                    <fragment>
                      <span className="thq-body-small">/cookies</span>
                    </fragment>
                  )}
                </span>
              </div>
